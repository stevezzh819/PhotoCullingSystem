...
function AsciiGhost() {
  ...
  const scaleRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const compute = () => {
      ...
      const nh2 = art.scrollHeight;
      if (!nw || !nh2) return;
      const s = Math.min(wrap.offsetWidth * 0.8 / nw, wrap.offsetHeight * 0.8 / nh2);
  ...
  reactExports.useEffect(() => {
    ...
    const FS = 11;
    const TARGET_DENSITY = 8e3;
    let drops = [];
    const mkDrop = (w2, h, randomY = true) => ({
      x: Math.floor(Math.random() * (w2 / FS)) * FS,
    ...
    ro.observe(canvas);
    const FPS = 20;
    const FRAME_MS = 1e3 / FPS;
    let lastDraw = 0;
    let lastTime = performance.now();
    let id2;
    const tick = (now2) => {
      id2 = requestAnimationFrame(tick);
      if (now2 - lastDraw < FRAME_MS) return;
      const dt = Math.min((now2 - lastTime) / 1e3, 0.05);
      lastDraw = now2;
      lastTime = now2;
      ...
      for (const d of drops) {
        ...
        if (d.y > h + FS) Object.assign(d, mkDrop(w2, h, false));
      }
    };
    id2 = requestAnimationFrame(tick);
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ascii-ghost-float", style: { position: "relative", zIndex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scaleRef, style: { transformOrigin: "center center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "pre",
          {
            ref: artRef,
            style: {
...
const T = {
  en: {
    ...
    undo: "Undo",
    allDone: "All done",
    keptAndDeleted: (k2, d) => `${k2} kept · ${d} marked for deletion`,
    undoLast: "← Undo last",
    reviewDelete: "Review & Delete →",
    reviewDeletions: "Review deletions",
    keptWillDelete: (k2, d) => `${k2} kept · ${d} will be moved to Trash`,
    statKept: "Kept",
    ...
    back: "← Back",
    moveToTrash: (n2) => `Move ${n2} file${n2 !== 1 ? "s" : ""} to Trash`,
    movingToTrash: "Moving to Trash…",
    movedToTrash: (n2) => `${n2} file${n2 !== 1 ? "s" : ""} moved to Trash`,
    imagesKept: (n2) => `${n2} image${n2 !== 1 ? "s" : ""} kept`,
  ...
  zh: {
    ...
    undo: "撤销",
    allDone: "全部完成",
    keptAndDeleted: (k2, d) => `已保留 ${k2} 张 · 标记删除 ${d} 张`,
    undoLast: "← 撤销",
    reviewDelete: "确认删除 →",
    reviewDeletions: "确认删除",
    keptWillDelete: (k2, d) => `${k2} 张保留 · ${d} 张将移入废纸篓`,
    statKept: "保留",
    statDeleting: "删除",
    statTotal: "总计",
    filesToDelete: "待删除文件",
    ...
    back: "← 返回",
    moveToTrash: (n2) => `将 ${n2} 个文件移入废纸篓`,
    movingToTrash: "正在移入废纸篓…",
    movedToTrash: (n2) => `${n2} 个文件已移入废纸篓`,
    imagesKept: (n2) => `已保留 ${n2} 张图片`,
    startOver: "← 重新开始"
  }
};
...
function LangProvider({ children }) {
  const [lang, setLangState] = reactExports.useState(
    () => localStorage.getItem("quickd-lang") || "en"
  );
  const setLang = (l2) => {
    setLangState(l2);
    localStorage.setItem("quickd-lang", l2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LangContext.Provider, { value: { lang, setLang }, children });
}
function useLang() {
  ...
  const loadFolder = reactExports.useCallback(
    async (folderPath) => {
      ...
      try {
        ...
        if (images.length === 0) {
          setError(t2.noImages);
          setIsLoading(false);
          return;
        }
        onFolderSelected(folderPath, images);
      } catch {
        setError(t2.failedRead);
        setIsLoading(false);
      }
    },
    [onFolderSelected, t2]
  ...
  const handleDrop = reactExports.useCallback(
    async (e) => {
      ...
      if (entry?.isDirectory) {
        await loadFolder(item.getAsFile().path);
      }
    },
    [loadFolder]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        background: "radial-gradient(ellipse at 25% 15%, rgba(99,102,241,0.10) 0%, transparent 55%), radial-gradient(ellipse at 75% 85%, rgba(236,72,153,0.07) 0%, transparent 55%), #0c0c0e",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AsciiGhost, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-spacer", style: { width: "100%" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "no-drag",
            ...
            children: ["en", "zh"].map((l2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setLang(l2),
                style: {
                  ...
                  background: lang === l2 ? "rgba(99,102,241,0.25)" : "transparent",
                  color: lang === l2 ? "#a5b4fc" : "rgba(255,255,255,0.35)"
                },
                children: l2 === "en" ? "EN" : "中文"
              },
              l2
            ))
          }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  style: {
                    ...
                    aspectRatio: "16 / 9",
                    borderRadius: 20,
                    border: `1.5px dashed ${isDragging2 ? "rgba(99,102,241,0.7)" : "rgba(255,255,255,0.12)"}`,
                    background: isDragging2 ? "rgba(99,102,241,0.08)" : "rgba(255,255,255,0.025)",
                    ...
                    cursor: "pointer",
                    boxShadow: isDragging2 ? "0 0 0 4px rgba(99,102,241,0.12), 0 20px 60px rgba(0,0,0,0.4)" : "0 20px 60px rgba(0,0,0,0.3)"
                  },
                  ...
                  children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "40", height: "40", viewBox: "0 0 40 40", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "path",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 15, fontWeight: 500, color: "rgba(255,255,255,0.7)", marginBottom: 4 }, children: isDragging2 ? t2.dropHere : t2.selectFolder }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "rgba(255,255,255,0.3)" }, children: t2.dragDrop })
                    ] })
                  ] })
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    { key: "K", label: t2.keep },
                    { key: "U", label: t2.undo }
                  ].map(({ key, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "key-badge", children: key }),
...
const cardStyle = {
  ...
  borderRadius: 18,
  overflow: "hidden",
  boxShadow: "0 48px 100px rgba(0,0,0,0.65), 0 16px 40px rgba(0,0,0,0.4), 0 0 0 0.5px rgba(255,255,255,0.07)",
  background: "#111113",
  lineHeight: 0
};
const imgStyle = {
...
function SwipeCard({ imageSrc, enterFrom, swipeDirection, onExitComplete }) {
  const controls = useAnimation();
  const exitCalledRef = reactExports.useRef(false);
  const onExitRef = reactExports.useRef(onExitComplete);
  onExitRef.current = onExitComplete;
  reactExports.useEffect(() => {
    exitCalledRef.current = false;
    const x0 = enterFrom === "nav-left" || enterFrom === "undo-left" ? -60 : enterFrom === "nav-right" || enterFrom === "undo-right" ? 60 : 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: cardStyle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: toLocalSrc(imageSrc), draggable: false, style: imgStyle }),
        stamp && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
...
function useImageCuller(images) {
  ...
  const preloadCacheRef = reactExports.useRef(/* @__PURE__ */ new Map());
  reactExports.useEffect(() => {
    setViewIndex(0);
    setDecisions(/* @__PURE__ */ new Map());
    setHistory([]);
    preloadCacheRef.current.clear();
  }, [images]);
  const isDone = images.length > 0 && decisions.size >= images.length;
  const canUndo = history.length > 0;
  const act = reactExports.useCallback(
    (type) => {
      const idx = viewIndex;
      ...
      setHistory((h) => [...h.filter((i) => i !== idx), idx]);
      setViewIndex(next);
    },
  ...
  return {
    ...
    keptCount: [...decisions.values()].filter((v2) => v2 === "keep").length,
    deletedCount: [...decisions.values()].filter((v2) => v2 === "delete").length,
    toDeletePaths,
    isDone,
    canUndo,
...
function useKeyboard(keyMap, enabled = true) {
  const mapRef = reactExports.useRef(keyMap);
...
function ImageViewer({ images, folderPath, onDone }) {
  ...
  const progress2 = culler.totalCount > 0 ? culler.processedCount / culler.totalCount : 0;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          ...
          display: "flex",
          flexDirection: "column",
          background: "radial-gradient(ellipse at 25% 15%, rgba(99,102,241,0.08) 0%, transparent 55%), #0c0c0e"
        },
        className: "dot-grid",
        children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 28, fontWeight: 600, letterSpacing: "-0.5px", marginBottom: 8 }, children: t2.allDone }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "rgba(255,255,255,0.4)", fontSize: 15 }, children: t2.keptAndDeleted(culler.keptCount, culler.deletedCount) })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      culler.canUndo && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: undo, style: ghostBtn, className: "no-drag", children: t2.undoLast }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-drag", style: { display: "flex", alignItems: "center", gap: 12 }, children: [
                culler.currentDecision && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.span,
                  {
                    ...
                    style: {
                      ...
                      padding: "3px 8px",
                      borderRadius: 5,
                      background: culler.currentDecision === "keep" ? "rgba(48,209,88,0.15)" : "rgba(255,69,58,0.15)",
                    ...
                    children: culler.currentDecision === "keep" ? t2.badgeKept : t2.badgeDelete
                  },
                  culler.viewIndex
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.85)" }, children: culler.viewIndex + 1 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { margin: "0 4px" }, children: "/" }),
                      culler.totalCount
                    ]
                  }
                )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 2, background: "rgba(255,255,255,0.05)", flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            style: { height: "100%", background: "linear-gradient(90deg, #6366f1, #8b5cf6)" },
            animate: { width: `${progress2 * 100}%` },
            transition: { type: "spring", stiffness: 120, damping: 20 }
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, position: "relative", overflow: "hidden" }, children: culler.currentImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
          SwipeCard,
          {
...
function Sep() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, height: 16, background: "rgba(255,255,255,0.08)" } });
}
function Hint({
  k: k2,
  label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "key-badge", style: active ? { background: color2, color: "#fff", borderColor: color2 } : {}, children: k2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, fontWeight: 500, color: active ? color2 : dim }, children: label })
      ]
    }
  );
}
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 22, fontWeight: 600, marginBottom: 8 }, children: t2.movedToTrash(toDeletePaths.length) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "rgba(255,255,255,0.4)", fontSize: 14, marginBottom: 32 }, children: t2.imagesKept(keptCount) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: onStartOver,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        display: "flex",
        flexDirection: "column",
        background: "radial-gradient(ellipse at 20% 10%, rgba(239,68,68,0.06) 0%, transparent 50%), #0c0c0e"
      },
      className: "dot-grid",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-spacer" }),
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: t2.reviewDeletions
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, color: "rgba(255,255,255,0.4)" }, children: t2.keptWillDelete(keptCount, toDeletePaths.length) })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  style: { display: "flex", gap: 12 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: keptCount, label: t2.statKept, color: "#30d158" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: toDeletePaths.length, label: t2.statDeleting, color: "#ff453a" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: totalImages, label: t2.statTotal, color: "rgba(255,255,255,0.5)" })
                  ]
                }
              ),
              toDeletePaths.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  initial: { opacity: 0 },
                  animate: { opacity: 1 },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: t2.filesToDelete
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflowY: "auto", maxHeight: "calc(100% - 36px)", padding: "4px 0" }, children: toDeletePaths.map((filePath, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        style: {
                          ...
                          alignItems: "center",
                          gap: 10,
                          borderBottom: i < toDeletePaths.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    toDeletePaths.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        style: {
                          ...
                          borderRadius: 10,
                          border: "none",
                          background: isDeleting ? "rgba(255,69,58,0.4)" : "linear-gradient(135deg, #ff453a 0%, #ff2d55 100%)",
                          color: "#fff",
                          fontSize: 14,
                          fontWeight: 600,
                          cursor: isDeleting ? "not-allowed" : "pointer",
                        ...
                        children: isDeleting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          ...
                          t2.movingToTrash
                        ] }) : t2.moveToTrash(toDeletePaths.length)
                      }
                    )
                  ]
                }
...
function StatCard({ value, label, color: color2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "rgba(255,255,255,0.35)", marginTop: 4, fontWeight: 500 }, children: label })
      ]
    }
  );
}
...
function App() {
  const [screen, setScreen] = reactExports.useState("welcome");
  const [session, setSession] = reactExports.useState(null);
  const [toDeletePaths, setToDeletePaths] = reactExports.useState([]);
  const handleFolderSelected = (folderPath, images) => {
    setSession({ folderPath, images });
    setToDeletePaths([]);
    setScreen("culling");
  };
  const handleCullingDone = (paths) => {
  ...
  }, [screen, toDeletePaths]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LangProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", height: "100%", background: "#0c0c0e" }, children: [
    screen !== "culling" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "fixed",
        ...
        children: "© VIART PTE. LTD. 2026"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
      screen === "welcome" && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { width: "100%", height: "100%" }, ...screenTransition, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderSelector, { onFolderSelected: handleFolderSelected }) }, "welcome"),
      screen === "culling" && session && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { width: "100%", height: "100%" }, ...screenTransition, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ImageViewer,
        {
      ...
      screen === "summary" && session && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { width: "100%", height: "100%" }, ...screenTransition, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryScreen,
        {
